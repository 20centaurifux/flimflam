...
(def ^:private parser
  (insta/parser
   "address = local-part '@' domain
    ...
    v6 = (v680 | v670 | v671 | v672 | v673 | v674 | v675 | v676 | v677
          | v660 | v661 | v662 | v663 | v664 | v665 | v666
          | v650 | v651 | v652 | v653 | v654 | v655
          | v640 | v641 | v642 | v643 | v644
          | v630 | v631 | v632 | v633
          | v620 | v621 | v622 | v610 | v611
          | v600 | v6604 | v6504 | v6514 | v6524 | v6534 | v6544 | v6554
...
(defn invalid?
  "Tests if address is an invalid email address."
  [address]
  (-> address
      unfold
      parser
...
(defn valid?
  "Tests if address is a valid email address"
  [address]
  (not (invalid? address)))
